 ...
 */
export declare function repoGetValue(repo: Repo, query: Query): Promise<DataSnapshot>;
...
export declare function repoGetDatabase(repo: Repo): Database;
/**
 ...
 */
export declare function repoStartTransaction(repo: Repo, path: Path, transactionUpdate: (a: unknown) => unknown, onComplete: ((a: Error, b: boolean, c: DataSnapshot) => void) | null, applyLocally: boolean): void;
export {};
