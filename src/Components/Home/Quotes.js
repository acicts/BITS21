...
function Quotes() {
    ...
    return (
        <div>
            ...
            <div className={classes.quoteContainer}>
                <Typography align='right' variant='h4'> <span style={{color: '#3ed1b8', fontSize: '50px'}}>“</span> I think BITS will have a great impact on the students who like the technical side of the life <span style={{color: '#3ed1b8', fontSize: '50px'}}>”</span> </Typography>
